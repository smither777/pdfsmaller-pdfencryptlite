...
import { encodePasswordLegacy, PasswordEncodingError } from './password-encoding.js';
 ...
 */
export async function encryptPDF(pdfBytes, userPassword, ownerPasswordOrOptions = null) {
  try {
